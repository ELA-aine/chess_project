...
public:
    ...
    bool isValidMove(const std::string &from, const std::string &to, const std::unique_ptr<Board> &board) const override;  // Overrides to check if the move is valid for a Bishop
